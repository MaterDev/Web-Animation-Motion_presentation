// @ts-nocheck -- copied from design/techniques/skin.js (a classic script); self.X globals became named exports
...
export const SKIN_BAYER = function (n) {
...
export const SKIN_RAMP = function (anchors, steps) {
  var out = [], i, u, s, f, a, b;
  for (i = 0; i < steps; i++) {
...
export const SKIN_QUANTISE = function (d, W, H, pal, n, cache) {
  var bayer = n ? SKIN_BAYER(n) : null;
...
export const SKIN_CACHE = function () {
...
/* ── the bevel ──────────────────────────────────────────────────────────
   ...
   precisely, not less. */
export const SKIN_BEVEL = function (ctx, x, y, w, h, sunken, c) {
...
export const SKIN_CSS = function (c) { return 'rgb(' + c[0] + ',' + c[1] + ',' + c[2] + ')'; };
...
export const SKIN_HASH2 = function (x, y, seed) {
...
export const SKIN_NOISE = function (x, y, freq, seed) {
